...
{
   // array of Triangles
   private final Triangle[] collection;
   ...
   public TriangleCollection(int numTriangles, int startX, int startY)
   {
       ...
       Point vertexOne = new Point(-startX, 0);
       Point vertexTwo = new Point(0, startY);


       for (int i = 0; i < numTriangles; i++)
       {
           Point vertexThree = new Point(startX - i, 0);
           collection[i] = new Triangle(vertexOne, vertexTwo, vertexThree);
       }
   }
